...
export const updateUser = async (req, res) => {
  try {
    ...
    if (skills) {
      if (skills.image1) {
        if (user.skills.image1 && user.skills.image1.public_id) {
      ...
      if (skills.image2) {
        if (user.skills.image2 && user.skills.image2.public_id) {
      ...
      if (skills.image3) {
        if (user.skills.image3 && user.skills.image3.public_id) {
      ...
      if (skills.image4) {
        if (user.skills.image4 && user.skills.image4.public_id) {
          await cloudinary.v2.uploader.destroy(user.skills.image1.public_id);
        }
      ...
      if (skills.image5) {
        if (user.skills.image5 && user.skills.image5.public_id) {
      ...
      if (skills.image6) {
        if (user.skills.image6 && user.skills.image6.public_id) {
